...
import PostAvatar from "../assets/appoint.jpg";
...
import APPOINTMENTS from "./Appointments_List.js"
import { get_appointments } from "../actions/data_ops.js";
        ...
        <div className={classes.root}>
            ...
            <Container maxWidth="lg" className={classes.wizardContainer}>
               <div className={classes.head}>
                ...
                <div>
                   <APPOINTMENTS data={props.appointments} />	
                </div>
...
const mapStateToProps = (state) => ({
    ...
    appointments: state.data_ops.appointments,
